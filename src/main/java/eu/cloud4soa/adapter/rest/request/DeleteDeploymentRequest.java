...
/**
 * Request for deletion of resource <strong>Deployment</strong> 
...
public class DeleteDeploymentRequest extends Request<DeleteDeploymentResponse> implements Serializable{
	private static final long serialVersionUID = -2621376151735882358L;
