...
/**
 * Request for update of resource <strong>Deployment</strong>  
 * <br><code>htt[p|ps]://baseUrl/ems/application/${applicationName}/deployment/${deploymentName}</code>.<br>
 * 
...
public class UpdateDeploymentRequest extends Request<UpdateDeploymentResponse> implements Serializable{
	private static final long serialVersionUID = 6257359575619168791L; 
